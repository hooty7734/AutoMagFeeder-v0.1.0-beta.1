-- Auto-converted from LEGACY plan: (T4)(S3.9)MIND-5.00-0.00-45.00-49.90-Leilla.Pilla.Mylla-1mf-RareS4-V-B-R-W.mag
...
return {
    ...
    sequence = {
        ...
        },
        {
            ...
            item = "Monofluid",
            count = 239,
            start_state = { level = 76, def = 5.00, pow = 0.00, dex = 45.00, mind = 26.00 },
            feed_value = { def = 0, pow = 0, dex = 0, mind = 10 }
        }
    }
}
